package fr.mylocalphone.sanbot.activities.restaurantbarbakery;
...
public class RestaurantBarBakeryActivity extends TopBaseActivity {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_restaurant_bar_bakery);
        ...
        WebView wvRestaurantBarBakery = findViewById(R.id.wvRestaurantBarBakery);
        wvRestaurantBarBakery.setWebViewClient(new WebViewClient());
        WebSettings webSettings = wvRestaurantBarBakery.getSettings();
        webSettings.setJavaScriptEnabled(true);
        wvRestaurantBarBakery.loadUrl(Hotel.geteInfos().rbb);
